...
/// Validates a decoded JSON question-set payload against the schema in
/// docs/PRD.md section 4, collecting every error instead of throwing on the
/// first one so the import screen can show what's wrong per-question
/// (PRD section 5.1: "don't silently drop them").
class QuestionSetValidator {
  static QuestionSetValidationResult validate(Map<String, dynamic> json) {
    ...
    for (var i = 0; i < rawQuestions.length; i++) {
      ...
      valid.add(Question.fromJson(raw, ''));
    }
